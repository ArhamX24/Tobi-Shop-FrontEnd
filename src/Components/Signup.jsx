...
import { signupUrl, baseUrl, getUrl } from "../Utility/constant.js";
...
const SignUp = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      username: Yup.string().min(2, "Length too short"),
    ...
    onSubmit: async (values, action )=> {
      ...
      let response = await axios.post(baseUrl+signupUrl, {username, email, password, phNumber}, {withCredentials: true})
      ...
      <div className="flex  min-h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-slate-100">
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
                ...
                {
                  formik.touched.username && formik.errors.username ?<p className="text-red-900">{formik.errors.username}</p> : null
                }
              </div>
              <div>
                <label htmlFor="email" className="block text-sm font-medium leading-6 text-gray-900">
              ...
              <div>
                ...
                {
                  formik.touched.confirmPassword && formik.errors.confirmPassword ?<p className="text-red-900">{formik.errors.confirmPassword}</p> : null
                }
              </div>
              ...
              <div>
                ...
                {
                  formik.touched.phNumber && formik.errors.phNumber ?<p className="text-red-900">{formik.errors.phNumber}</p> : null
                }
              </div>
